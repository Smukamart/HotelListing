    ...
    public class DatabaseContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Hotel>().HasData(
                new Hotel { Id = 1, Name = "Sandals Hotel and Spa", Address = "Negril", CountryId = 1, Rating = 4.5 },
                new Hotel { Id = 2, Name = "Confort Suites", Address = "Geoge Town", CountryId = 3, Rating = 4.3 },
